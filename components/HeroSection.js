export default function HeroSection() {
    return (
      <section className="relative bg-gradient-to-r from-[#00c6ff] to-[#0072ff] py-16">
        <div className="container mx-auto flex flex-col items-center justify-center px-4 text-center text-white">
          ...
          <div className="mt-6 flex space-x-4">
            ...
            <a
              href="#contact"
              className="px-6 py-3 bg-blue-700 font-semibold rounded-lg shadow hover:bg-blue-800"
            >
              Contact Us
            </a>
          </div>
